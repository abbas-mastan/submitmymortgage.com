...
@section('content')
    ...
    <div class="flex flex-wrap flex-shrink-0">
        <table class="w-full">
            <caption class="text-center font-bold mb-3">Loan Application</caption>
            <thead class="bg-gray-300">
                <tr>
                    <th class=" pl-2 tracking-wide">S No.</th>
                    <th class="">File Title</th>
                    <th class="">Status</th>
                    ...
                    <tr>
                        ...
                        <td class=" pl-2 tracking-wide border border-r-0">
                            <a data="Delete"  class="delete" 
                                title="Delete this file" href="{{ url(getRoutePrefix() . '/delete-file/' . $file->id) }}">
