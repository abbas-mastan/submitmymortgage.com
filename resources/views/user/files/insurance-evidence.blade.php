...
@section('content')
    ...
    <div class="flex flex-wrap flex-shrink-0">
        ...
        <table class="w-full">
            <caption class="text-center font-bold mb-3">Evidence of Insurance</caption>
            ...
            <tbody>
                @foreach ($files as $file)
                    <tr>
                        ...
                        <td class=" pl-2 tracking-wide border border-l-0" class="hover:text-blue-500">
