...
Route::group(['middleware' => 'guest'], function () {
    ...
    Route::view('/about', 'front-pages/second-about')->name("about");
    Route::view('/verification', 'front-pages/second-verification')->name("verification");
    Route::view('/origination', 'front-pages/originations')->name("origination");
    Route::view('/platform', 'front-pages/second-platform')->name("platform");
    Route::view('/closing', 'front-pages/closing')->name("closing");
    Route::view('/carousel', 'front-pages/carousel')->name("carousel");
