...
@endcomponent
@component('components.modal-background', ['title' => 'Add New Members','id'=>'AddNewMemberModal'])
    <div>
        <form class="AddMemberForm" method="post">
            @csrf
            <div class="my-3">
                <div class="relative text-left">
                    <label for="Associate" class="text-sm text-dark-500 leading-6 font-bold">Select Associate</label>
            ...
            <div class="my-3 flex justify-between mt-10">
                <span class="bg-gray-400 px-8 py-1 text-white cursor-pointer capitalize backTotype">back</span>
                <button type="submit" class="bg-red-800 text-white px-5 text-xs font-thin teamContinue">Continue</button>
            </div>
        </form>
    </div>
@endcomponent
