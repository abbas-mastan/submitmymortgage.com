        ...
        <div>
            ...
            <div class="h-[50%] child w-100 flex-col justify-center mt-5 shadow-2xl bg-white p-10">
                ...
                <div class="flex justify-center">
                    <a href="" class="text-center my-5 bg-black rounded text-white px-3 py-1.5">Create Password</a>
                </div>
                ...
                <p class="text-sm text-gray-400">
                    If you're having trouble clicking the "Choose Password" button, copy and paste the URL below into your
                    web browse:  
                </p>
            </div>
        </div>
