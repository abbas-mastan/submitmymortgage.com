                    ...
                    <form id="payment-form" class="main-form require-validation"
                        ...
                        <div class="tab2">
                            <div class="form-inp-sec d-flex flex-column">
                                ...
                                <div class="d-none discount form-inp-div ">
                                    <div class="form-inps border-bottom-0">
                                        <label for="discount-code-input">Discount Code</label><br>
                                        <input id="discount-code-input" placeholder="Discount Code"  class="input1" name="discount_code" type="text">
