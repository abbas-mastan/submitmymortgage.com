<div class="flex justify-evenly gap-8 align-center">
    <div class="sm:w-2/3 w-full">
        <div @class([
            ...
            'flex-col',
            'sm:flex-row',
            'justify-center' => Auth::user()->role === 'Borrower',
            'justify-between' => Auth::user()->role !== 'Borrower',
            'w-full',
            'gap-8',
            'mt-8',
        ])>
            <a href="{{ url(getRoutePrefix() . '/projects') }}" class="flex justify-center align-center flex-col">
                ...
                <p class="text-center font-bold">{{ Auth::user()->role === 'Borrower' ? 'Deal' : 'Deals' }}</p>
            </a>
            @if (Auth::user()->role !== 'Borrower')
                @if (Auth::user()->role !== 'Junior Associate')
