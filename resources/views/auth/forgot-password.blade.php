    ...
    <div class="mx-auto w-1/3 mt-40">
        ...
        <form action="{{url('/forgot-password')}}" method="post" class=" w-7/8">
            ...
            <div class="mt-2 text-center">
                ...
                <a href="{{ url('/register') }}">
                    <button type="button" class="text-white opacity-70 rounded-md bg-transparent border-2 border-white px-4 py-2  focus:outline-none focus:border-none  focus:ring-1 focus:ring-blue-400">
                        Send a Reset Link
                    </button>
                </a>
