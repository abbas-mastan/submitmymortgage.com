...
class IntakeFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'current_loan_amount' => 'required_if:loan_type,Purchase',
            'closing_date' => 'required_if:loan_type,Purchase',
            'current_loan_amount' => 'required_if:loan_type,Cash Out',
            ...
            'current_loan_amount' => 'required_if:loan_type,Refinance',
