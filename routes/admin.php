...
use App\Http\Controllers\{UserController,HomeController,AdminController,};
...
Route::middleware(['auth', 'admin'])->prefix(getAdminRoutePrefix())->group(function () {
    ...
    Route::get('/getUsersByTeam/{team}', [AdminController::class, 'getUsersByTeam']);
    ...
    Route::post('/get-associates', [AdminController::class, 'getAssociates']);
